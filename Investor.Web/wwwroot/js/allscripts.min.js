if (function (e, t) {
    ...
    function m(e, t, n, i) {
        var o, r = 1,
            ...
            u = (me.cssNumber[t] || "px" !== c && +l) && Me.exec(me.css(e, t));
        if (u && u[3] !== c) {
            c = c || u[3], n = n || [], u = +l || 1;
            do {
                r = r || ".5", u /= r, me.style(e, t, u + c)
            } while (r !== (r = a() / l) && 1 !== r && --s)
        }
    ...
    function g(e) {
        var t, n = e.ownerDocument,
            i = e.nodeName,
            o = qe[i];
        return o || (t = n.body.appendChild(n.createElement(i)), o = me.css(t, "display"), t.parentNode.removeChild(t), "none" === o && (o = "block"), qe[i] = o, o)
    }

    function v(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++) i = e[r], i.style && (n = i.style.display, t ? ("none" === n && (o[r] = He.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && ze(i) && (o[r] = g(i))) : "none" !== n && (o[r] = "none", He.set(i, "display", n)));
        ...
        for (var r, s, a, l, c, u, d = t.createDocumentFragment(), p = [], h = 0, f = e.length; h < f; h++)
            if ((r = e[h]) || 0 === r)
                if ("object" === me.type(r)) me.merge(p, r.nodeType ? [r] : r);
                    ...
                    for (s = s || d.appendChild(t.createElement("div")), a = (Ve.exec(r) || ["", ""])[1].toLowerCase(), l = Ge[a] || Ge._default, s.innerHTML = l[1] + me.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
                    me.merge(p, s.childNodes), s = d.firstChild, s.textContent = ""
                } else p.push(t.createTextNode(r));
        for (d.textContent = "", h = 0; r = p[h++];)
            if (i && me.inArray(r, i) > -1) o && o.push(r);
            else if (c = me.contains(r.ownerDocument, r), s = y(d.appendChild(r), "script"), c && b(s), n)
    ...
    function A(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            $e.hasData(e) && (a = $e.access(e), l = me.extend({}, a), $e.set(t, l))
        }
    }
    ...
    function I(e, t, i, o) {
        ...
        var r, s, a, l, c, u, d = 0,
            ...
            f = t[0],
            m = me.isFunction(f);
        if (m || p > 1 && "string" == typeof f && !he.checkClone && nt.test(f)) return e.each(function (n) {
            var r = e.eq(n);
            m && (t[0] = f.call(this, n, r.html())), I(r, t, i, o)
        });
        if (p && (r = w(t, e[0].ownerDocument, !1, e, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
            for (a = me.map(y(r, "script"), x), l = a.length; d < p; d++) c = r, d !== h && (c = me.clone(c, !0, !0), l && me.merge(a, y(c, "script"))), i.call(e[d], c, d);
            if (l)
                for (u = a[a.length - 1].ownerDocument, me.map(a, k), d = 0; d < l; d++) c = a[d], Ye.test(c.type || "") && !He.access(c, "globalEval") && me.contains(u, c) && (c.src ? me._evalUrl && me._evalUrl(c.src) : n(c.textContent.replace(ot, ""), u))
        }
        return e
    }

    function D(e, t, n) {
        for (var i, o = t ? me.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || me.cleanData(y(i)), i.parentNode && (n && me.contains(i.ownerDocument, i) && b(y(i, "script")), i.parentNode.removeChild(i));
        return e
    }

    function N(e, t, n) {
        var i, o, r, s, a = e.style;
        return n = n || at(e), n && (s = n.getPropertyValue(t) || n[t], "" !== s || me.contains(e.ownerDocument, e) || (s = me.style(e, t)), !he.pixelMarginRight() && st.test(s) && rt.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function j(e, t, n, i, o) {
        var r, s = 0;
        for (r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; r < 4; r += 2) "margin" === n && (s += me.css(e, n + Fe[r], !0, o)), i ? ("content" === n && (s -= me.css(e, "padding" + Fe[r], !0, o)), "margin" !== n && (s -= me.css(e, "border" + Fe[r] + "Width", !0, o))) : (s += me.css(e, "padding" + Fe[r], !0, o), "padding" !== n && (s += me.css(e, "border" + Fe[r] + "Width", !0, o)));
        return s
    }
    ...
    function W(e, t, n) {
        ...
        return st.test(r) ? r : (i = s && (he.boxSizingReliable() || r === e.style[t]), "auto" === r && (r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (r = parseFloat(r) || 0) + j(e, t, n || (s ? "border" : "content"), i, o) + "px")
    }
    ...
    function M() {
        mt && (!1 === ne.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(M) : e.setTimeout(M, me.fx.interval), me.fx.tick())
    }
    ...
    function q(e, t, n) {
        ...
        if ((l = !me.isEmptyObject(t)) || !me.isEmptyObject(h)) {
            d && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = g && g.display, null == c && (c = He.get(e, "display")), u = me.css(e, "display"), "none" === u && (c ? u = c : (v([e], !0), c = e.style.display || c, u = me.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === me.css(e, "float") && (l || (p.done(function () {
                f.display = c
            }), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function () {
                f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
            })), l = !1;
            for (i in h) l || (g ? "hidden" in g && (m = g.hidden) : g = He.access(e, "fxshow", {
                display: c
            }), r && (g.hidden = !m), m && v([e], !0), p.done(function () {
                m || v([e]), He.remove(e, "fxshow");
                for (i in h) me.style(e, i, h[i])
            })), l = B(m ? g[i] : 0, i, p), i in g || (g[i] = l.start, m && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function U(e, t) {
        var n, i, o, r, s;
        for (n in e)
            if (i = me.camelCase(n), o = t[i], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = me.cssHooks[i]) && "expand" in s) {
    ...
    function V(e, t, n) {
        var i, o, r = 0,
            ...
            l = function () {
                if (o) return !1;
                for (var t = ft || F(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; s < l; s++) c.tweens[s].run(r);
        ...
        for (U(u, c.opts.specialEasing); r < s; r++)
            if (i = V.prefilters[r].call(c, e, u, c.opts)) return me.isFunction(i.stop) && (me._queueHooks(c.elem, c.opts.queue).stop = me.proxy(i.stop, i)), i;
        return me.map(u, B, c), me.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), me.fx.timer(me.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    me.fn = me.prototype = {
        ...
        var e, t, n, i, o, r, s = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || me.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
    ...
    var we = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : F) !== L && N(t), t = t || L, H)) {
                if (11 !== f && (l = ve.exec(e)))
                    if (o = l[1]) {
                        if (9 === f) {
                        ...
                        if ((o = l[3]) && _.getElementsByClassName && t.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(o)), n
                    }
                if (_.qsa && !V[e + " "] && (!$ || !$.test(e))) {
                    if (1 !== f) p = t, u = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(Te, _e) : t.setAttribute("id", a = M), c = x(e), r = c.length; r--;) c[r] = "#" + a + " " + h(c[r]);
        ...
        function f(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (l) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || s)
                            if (d = t[M] || (t[M] = {}), u = d[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t;
                            else {
        ...
        function b(e) {
            for (var t, n, i, o = e.length, r = E.relative[e[0].type], s = r || E.relative[" "], a = r ? 1 : 0, l = f(function (e) {
                ...
                var o = !r && (i || n !== O) || ((t = n).nodeType ? l(e, n, i) : c(e, n, i));
                return t = null, o
            }]; a < o; a++)
                if (n = E.relative[e[a].type]) u = [f(m(u), n)];
                    ...
                    if (n = E.filter[e[a].type].apply(null, e[a].matches), n[M]) {
                        ...
                        return y(a > 1 && m(u), a > 1 && h(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
            ...
            var o = n.length > 0,
                ...
                s = function (i, s, a, l, c) {
                    var u, d, p, h = 0,
                        ...
                        T = b.length;
                    for (c && (O = s === L || s || c); f !== T && null != (u = b[f]); f++) {
                        if (r && u) {
                            for (d = 0, s || u.ownerDocument === L || (N(u), a = !H); p = e[d++];)
                                if (p(u, s || L, a)) {
                                    l.push(u);
                                    break
                                }
        ...
        var T, _, E, C, S, x, k, A, O, I, D, N, L, P, H, $, j, W, R, M = "sizzle" + 1 * new Date,
            F = e.document,
            z = 0,
            B = 0,
            q = n(),
        ...
        _ = t.support = {}, S = t.isXML = function (e) {
            ...
            return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, P = L.documentElement, H = !S(L), F !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ee, !1) : n.attachEvent && n.attachEvent("onunload", Ee)), _.attributes = o(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), _.getElementsByTagName = o(function (e) {
                return e.appendChild(L.createComment("")), !e.getElementsByTagName("*").length
            }), _.getElementsByClassName = ge.test(L.getElementsByClassName), _.getById = o(function (e) {
                return P.appendChild(e).id = M, !L.getElementsByName || !L.getElementsByName(M).length
            ...
            }, j = [], $ = [], (_.qsa = ge.test(L.querySelectorAll)) && (o(function (e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && $.push("name" + ne + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && $.push(":enabled", ":disabled"), P.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && $.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), $.push(",.*:")
            })), (_.matchesSelector = ge.test(W = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && o(function (e) {
                _.disconnectedMatch = W.call(e, "*"), W.call(e, "[s!='']:x"), j.push("!=", re)
            }), $ = $.length && new RegExp($.join("|")), j = j.length && new RegExp(j.join("|")), t = ge.test(P.compareDocumentPosition), R = t || ge.test(P.contains) ? function (e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !_.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === F && R(F, e) ? -1 : t === L || t.ownerDocument === F && R(F, t) ? 1 : I ? ee(I, e) - ee(I, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return D = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== L && N(e), n = n.replace(ue, "='$1']"), _.matchesSelector && H && !V[n + " "] && (!j || !j.test(n)) && (!$ || !$.test(n))) try {
                var i = W.call(e, n);
            ...
            var n = E.attrHandle[t.toLowerCase()],
                i = n && G.call(E.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
            return void 0 !== i ? i : _.attributes || !H ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ? i.value : null
        }, t.escape = function (e) {
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (D = !_.detectDuplicates, I = !_.sortStable && e.slice(0), e.sort(Y), D) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                for (p = g, d = p[M] || (p[M] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], h = c[0] === z && c[1], b = h && c[2], p = h && g.childNodes[h]; p = ++h && p && p[m] || (b = h = 0) || f.pop();)
                                    if (1 === p.nodeType && ++b && p === t) {
                                        u[e] = [z, h, b];
                                        break
                                    }
                            } else if (y && (p = t, d = p[M] || (p[M] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], h = c[0] === z && c[1], b = h), !1 === b)
                                for (;
                                    (p = ++h && p && p[m] || (b = h = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (d = p[M] || (p[M] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), u[e] = [z, b]), p !== t)););
                ...
                PSEUDO: function (e, n) {
                    ...
                    return r[M] ? r(n) : r.length > 1 ? (o = [e, e, "", n], E.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
        ...
        return p.prototype = E.filters = E.pseudos, E.setFilters = new p, x = t.tokenize = function (e, n) {
            ...
            for (a = e, l = [], c = E.preFilter; a;) {
                ...
                for (s in E.filter) !(o = he[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({
                    value: i,
                    type: s,
                    matches: o
                }), a = a.slice(i.length));
            ...
            var n, i = [],
                ...
                r = V[e + " "];
            if (!r) {
                for (t || (t = x(e)), n = t.length; n--;) r = b(t[n]), r[M] ? i.push(r) : o.push(r);
                r = V(e, w(o, i)), r.selector = e
            }
            return r
        }, A = t.select = function (e, t, n, i) {
            var o, r, s, a, l, c = "function" == typeof e && e,
                u = !i && x(e = c.selector || e);
            if (n = n || [], 1 === u.length) {
                if (r = u[0] = u[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && 9 === t.nodeType && H && E.relative[r[1].type]) {
                    if (!(t = (E.find.ID(s.matches[0].replace(be, we), t) || [])[0])) return n;
                    c && (t = t.parentNode), e = e.slice(r.shift().value.length)
                }
                for (o = he.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !E.relative[a = s.type]);)
                    if ((l = E.find[a]) && (i = l(s.matches[0].replace(be, we), ye.test(r[0].type) && d(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && h(r))) return Z.apply(n, i), n;
                        break
                    }
            }
            return (c || k(e, u))(i, t, !H, n, !t || ye.test(e) && d(t.parentNode) || t), n
        }, _.sortStable = M.split("").sort(Y).join("") === M, _.detectDuplicates = !!D, N(), _.sortDetached = o(function (e) {
    ...
    me.filter = function (e, t, n) {
        ...
        is: function (e) {
            return !!r(this, "string" == typeof e && Ee.test(e) ? me(e) : e || [], !1).length
        }
    });
    var xe, ke = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (me.fn.init = function (e, t, n) {
        ...
        if (n = n || xe, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof me ? t[0] : t, me.merge(this, me.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)), Ce.test(i[1]) && me.isPlainObject(t))
    ...
    me.fn.extend({
        ...
        me.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = me.filter(i, o)), this.length > 1 && (Oe[e] || me.uniqueSort(o), Ae.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var Ie = /[^\x20\t\r\n\f]+/g;
                                ...
                                var a = this,
                                    ...
                                    d = function () {
                                        ...
                                        if (!(t < s)) {
                                            ...
                                            d = e && ("object" == typeof e || "function" == typeof e) && e.then, me.isFunction(d) ? o ? d.call(e, r(s, n, l, o), r(s, n, c, o)) : (s++ , d.call(e, r(s, n, l, o), r(s, n, c, o), r(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, u = [e]), (o || n.resolveWith)(a, u))
                                        }
                                    },
                                    p = o ? d : function () {
                                        try {
    ...
    me.extend({
        hasData: function (e) {
            return $e.hasData(e) || He.hasData(e)
        },
        data: function (e, t, n) {
        ...
        data: function (e, t) {
            var n, i, o, r = this[0],
                s = r && r.attributes;
            if (void 0 === e) {
                if (this.length && (o = $e.get(r), 1 === r.nodeType && !He.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = me.camelCase(i.slice(5)), f(r, i, o[i])));
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                var n;
                if (r && void 0 === t) {
                    if (void 0 !== (n = $e.get(r, e))) return n;
    ...
    me.event = {
        ...
        add: function (e, t, n, i, o) {
            var r, s, a, l, c, u, d, p, h, f, m, g = He.get(e);
            if (g)
                for (n.handler && (r = n, n = r.handler, o = r.selector), o && me.find.matchesSelector(Qe, o), n.guid || (n.guid = me.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
                    return void 0 !== me && me.event.triggered !== t.type ? me.event.dispatch.apply(e, arguments) : void 0
                }), t = (t || "").match(Ie) || [""], c = t.length; c--;) a = Je.exec(t[c]) || [], h = m = a[1], f = (a[2] || "").split(".").sort(), h && (d = me.event.special[h] || {}, h = (o ? d.delegateType : d.bindType) || h, d = me.event.special[h] || {}, u = me.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, r), (p = l[h]) || (p = l[h] = [], p.delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, f, s) || e.addEventListener && e.addEventListener(h, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), me.event.global[h] = !0)
        },
        remove: function (e, t, n, i, o) {
            var r, s, a, l, c, u, d, p, h, f, m, g = He.hasData(e) && He.get(e);
            if (g && (l = g.events)) {
                for (t = (t || "").match(Ie) || [""], c = t.length; c--;)
                    if (a = Je.exec(t[c]) || [], h = m = a[1], f = (a[2] || "").split(".").sort(), h) {
                        for (d = me.event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, p = l[h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) u = p[r], !o && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(r, 1), u.selector && p.delegateCount-- , d.remove && d.remove.call(e, u));
                        s && !p.length && (d.teardown && !1 !== d.teardown.call(e, f, g.handle) || me.removeEvent(e, h, g.handle), delete l[h])
                    } else
            ...
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = me.event.handlers.call(this, a, c), t = 0;
                    ...
                    for (a.currentTarget = o.elem, n = 0;
                        (r = o.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((me.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
        ...
        return this instanceof me.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? T : _, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && me.extend(this, t), this.timeStamp = e && e.timeStamp || me.now(), void (this[me.expando] = !0)) : new me.Event(e, t)
    }, me.Event.prototype = {
    ...
    me.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(he.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || me.isXMLDoc(e)))
                for (s = y(a), r = y(e), i = 0, o = r.length; i < o; i++) O(r[i], s[i]);
            if (t)
                if (n)
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = me.camelCase(t),
                    l = ct.test(t),
                    c = e.style;
                return l || (t = H(a)), s = me.cssHooks[t] || me.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t] : (r = typeof n, "string" === r && (o = Me.exec(n)) && o[1] && (n = m(e, t, o), r = "number"), void (null != n && n === n && ("number" === r && (n += o && o[3] || (me.cssNumber[a] ? "" : "px")), he.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var o, r, s, a = me.camelCase(t);
            return ct.test(t) || (t = H(a)), s = me.cssHooks[t] || me.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = N(e, t, i)), "normal" === o && t in dt && (o = dt[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), me.each(["height", "width"], function (e, t) {
        me.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !lt.test(me.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? W(e, t, i) : Be(e, ut, function () {
                    return W(e, t, i)
                })
            },
            set: function (e, n, i) {
                var o, r = i && at(e),
                    s = i && j(e, t, i, "border-box" === me.css(e, "boxSizing", !1, r), r);
                return s && (o = Me.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = me.css(e, t)), $(e, n, s)
            }
        }
    ...
    me.Animation = me.extend(V, {
        ...
        var e, t = 0,
            n = me.timers;
        for (ft = me.now(); t < n.length; t++)(e = n[t])() || n[t] !== e || n.splice(t--, 1);
    ...
    me.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : me.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, o, r;
                if ("string" === n)
                    for (i = 0, o = me(this), r = e.match(Ie) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = G(this), t && He.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : He.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, n, i = 0;
    ...
    me.fn.extend({
        val: function (e) {
            ...
            })) : o ? (t = me.valHooks[o.type] || me.valHooks[o.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(_t, "") : null == n ? "" : n)) : void 0
        }
    }), me.extend({
        valHooks: {
            option: {
    ...
    me.extend(me.event, {
        trigger: function (t, n, i, o) {
            ...
            if (s = a = i = i || ne, 3 !== i.nodeType && 8 !== i.nodeType && !Et.test(h + me.event.triggered) && (h.indexOf(".") > -1 && (f = h.split("."), h = f.shift(), f.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[me.expando] ? t : new me.Event(h, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : me.makeArray(n, [t]), d = me.event.special[h] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !me.isWindow(i)) {
                    for (l = d.delegateType || h, Et.test(l + h) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                    a === (i.ownerDocument || ne) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (r = 0;
                    (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || h, u = (He.get(s, "events") || {})[t.type] && He.get(s, "handle"), u && u.apply(s, n), (u = c && s[c]) && u.apply && Pe(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = h, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), n) || !Pe(i) || c && me.isFunction(i[h]) && !me.isWindow(i) && (a = i[c], a && (i[c] = null), me.event.triggered = h, i[h](), me.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    me.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !me(this).is(":disabled") && It.test(this.nodeName) && !Ot.test(e) && (this.checked || !Ue.test(e))
            }).map(function (e, t) {
                var n = me(this).val();
    ...
    Ft.href = Ct.href, me.extend({
        ...
        ajax: function (t, n) {
            ...
            if (v.promise(E), f.url = ((t || f.url || Ct.href) + "").replace(jt, Ct.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(Ie) || [""], null == f.crossDomain) {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = me.param(f.data, f.traditional)), K(Wt, f, n, E), u) return E;
            d = me.event && f.global, d && 0 == me.active++ && me.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !$t.test(f.type), r = f.url.replace(Nt, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Dt, "+")) : (h = f.url.slice(r.length), f.data && (r += (xt.test(r) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (r = r.replace(Lt, "$1"), h = (xt.test(r) ? "&" : "?") + "_=" + St++ + h), f.url = r + h), f.ifModified && (me.lastModified[r] && E.setRequestHeader("If-Modified-Since", me.lastModified[r]), me.etag[r] && E.setRequestHeader("If-None-Match", me.etag[r])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && E.setRequestHeader("Content-Type", f.contentType), E.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Mt + "; q=0.01" : "") : f.accepts["*"]);
            for (p in f.headers) E.setRequestHeader(p, f.headers[p]);
            if (f.beforeSend && (!1 === f.beforeSend.call(m, E, f) || u)) return E.abort();
            if (_ = "abort", y.add(f.complete), E.done(f.success), E.fail(f.error), o = K(Rt, f, n, E)) {
    ...
    he.cors = !!Bt && "withCredentials" in Bt, he.ajax = Bt = !!Bt, me.ajaxTransport(function (t) {
        ...
        if (he.cors || Bt && !t.crossDomain) return {
            send: function (o, r) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(zt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                                text: a.responseText
    ...
    me.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = me.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Ut, "$1" + o) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
            return s || me.error(o + " was not called"), s[0]
        }, t.dataTypes[0] = "json", r = e[o], e[o] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === r ? me(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, qt.push(o)), s && me.isFunction(r) && r(s[0]), s = r = void 0
        }), "script"
        ...
        var i, o, r;
        return t || (he.createHTMLDocument ? (t = ne.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = ne.location.href, t.head.appendChild(i)) : t = ne), o = Ce.exec(e), r = !n && [], o ? [t.createElement(o[1])] : (o = w([e], t, r), r && r.length && me(r).remove(), me.merge([], o.childNodes))
    }, me.fn.load = function (e, t, n) {
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = Y(e.slice(a)), e = e.slice(0, a)), me.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && me.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        me.cssHooks[t] = L(he.pixelPosition, function (e, n) {
            if (n) return n = N(e, t), st.test(n) ? me(e).position()[t] + "px" : n
        })
    }), me.each({
        Height: "height",
        Width: "width"
    ...
    return me.noConflict = function (t) {
        return e.$ === me && (e.$ = Yt), t && e.jQuery === me && (e.jQuery = Vt), me
    }, t || (e.jQuery = e.$ = me), me
}), function (e, t) {
    ...
    function d(e, t, n, i) {
        return G(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], oe() ? n["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")] + i["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }

    function p() {
        var e = window.document.body,
            t = window.document.documentElement,
            n = oe() && window.getComputedStyle(t);
        return {
    ...
    function f(e) {
        ...
        if (d || f) {
            var m = t(e);
            d -= u(m, "x"), f -= u(m, "y"), r.width -= d, r.height -= f
        }
        return h(r)
    }
    ...
    function m(e, n) {
        ...
        return (o ? n.contains(l) : n === l && "BODY" !== l.nodeName) && (m = c(m, n)), m
    }
    ...
    function g(e) {
        var t = window.document.documentElement,
            ...
            o = G(t.clientHeight, window.innerHeight || 0),
            r = l(t),
            s = l(t, "left");
        return h({
    ...
    function y(e, t, o, r) {
        ...
        if ("viewport" === r) s = g(l);
            ...
            var c;
            "scrollParent" === r ? (c = i(n(e)), "BODY" === c.nodeName && (c = window.document.documentElement)) : c = "window" === r ? window.document.documentElement : r;
            var u = m(c, l);
    ...
    function A() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = T(this.state, this.popper, this.reference), e.placement = w(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = C(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = k(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    function N(e, t, n, o) {
        ...
        s.addEventListener(t, n, {
            passive: !0
        }), r || N(i(s.parentNode), t, n, o), o.push(s)
    }
    ...
    function B(e, t, n, i) {
        ...
        return "vh" === s || "vw" === s ? ("vh" === s ? G(document.documentElement.clientHeight, window.innerHeight || 0) : G(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r : r
    }
    ...
    function U(e, t) {
        var n, i = t.offset,
            ...
            a = r.reference,
            l = o.split("-")[0];
        return n = j(+i) ? [+i, 0] : q(i, s, a, l), "left" === l ? (s.top += n[0], s.left -= n[1]) : "right" === l ? (s.top += n[0], s.left += n[1]) : "top" === l ? (s.left += n[0], s.top -= n[1]) : "bottom" === l && (s.left += n[0], s.top += n[1]), e.popper = s, e
    }
    for (var V = Math.min, Y = Math.floor, G = Math.max, X = ["native code", "[object MutationObserverConstructor]"], Q = function (e) {
        return X.some(function (t) {
            return -1 < (e || "").toString().indexOf(t)
        })
    }, K = "undefined" != typeof window, Z = ["Edge", "Trident", "Firefox"], J = 0, ee = 0; ee < Z.length; ee += 1)
        if (K && 0 <= navigator.userAgent.indexOf(Z[ee])) {
            J = 1;
            break
        }
    var te, ne = K && Q(window.MutationObserver),
        ie = ne ? function (e) {
            var t = !1,
                n = 0,
        ...
        pe = function () {
            function t(n, i) {
                ...
                re(this, t), this.scheduleUpdate = function () {
                    ...
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = n.jquery ? n[0] : n, this.popper = i.jquery ? i[0] : i, this.options.modifiers = {}, Object.keys(le({}, t.Defaults.modifiers, r.modifiers)).forEach(function (e) {
                    o.options.modifiers[e] = le({}, t.Defaults.modifiers[e] || {}, r.modifiers ? r.modifiers[e] : {})
    ...
    return pe.Utils = ("undefined" == typeof window ? global : window).PopperUtils, pe.placements = ce, pe.Defaults = {
        placement: "bottom",
        eventsEnabled: !0,
        removeOnDestroy: !1,
        onCreate: function () { },
        ...
        modifiers: {
                ...
                fn: function (e) {
                    ...
                    if (i) {
                        var o = e.offsets,
                            ...
                            u = {
                                start: ae({}, l, r[l]),
                                end: ae({}, l, r[l] + r[c] - s[c])
                            };
                        e.offsets.popper = le({}, s, u[i])
                    }
                    return e
                }
            },
                ...
                fn: function (e, t) {
                    ...
                    var r = t.priority,
                        ...
                        a = {
                            primary: function (e) {
                                var n = s[e];
                                return s[e] < i[e] && !t.escapeWithReference && (n = G(s[e], i[e])), ae({}, e, n)
                            },
                            secondary: function (e) {
                                var n = "right" === e ? "left" : "top",
                                    o = s[n];
                                return s[e] > i[e] && !t.escapeWithReference && (o = V(s[n], i[e] - ("right" === e ? s.width : s.height))), ae({}, n, o)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function (e, n) {
                    ...
                    var o = e.placement.split("-")[0],
                        ...
                        f = l ? "bottom" : "right",
                        m = _(i)[c];
                    a[f] - m < s[d] && (e.offsets.popper[d] -= s[d] - (a[f] - m)), a[d] + m > s[f] && (e.offsets.popper[d] += a[d] + m - s[f]);
                    var g = a[d] + a[c] / 2 - m / 2,
                        v = t(e.instance.popper, "margin" + u).replace("px", ""),
                        y = g - h(e.offsets.popper)[d] - v;
                    return y = G(V(s[c] - m, y), 0), e.arrowElement = i, e.offsets.arrow = {}, e.offsets.arrow[d] = Math.round(y), e.offsets.arrow[p] = "", e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function (e, t) {
                    ...
                    return s.forEach(function (a, l) {
                        ...
                        (p || v || b) && (e.flipped = !0, (p || v) && (i = s[l + 1]), b && (r = F(r)), e.placement = i + (r ? "-" + r : ""), e.offsets.popper = le({}, e.offsets.popper, C(e.instance.popper, e.offsets.reference, e.placement)), e = k(e.instance.modifiers, e, "flip"))
                    }), e
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function (e) {
                    ...
                    return o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0), e.placement = E(t), e.offsets.popper = h(o), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    var a, l, c = void 0 === s ? t.gpuAcceleration : s,
                        ...
                        v = I("transform");
                    if (l = "bottom" == m ? -d.height + h.bottom : h.top, a = "right" == g ? -d.width + h.right : h.left, c && v) p[v] = "translate3d(" + a + "px, " + l + "px, 0)", p[m] = 0, p[g] = 0, p.willChange = "transform";
                    else {
                        var y = "bottom" == m ? -1 : 1,
                            b = "right" == g ? -1 : 1;
                    ...
                    return e.attributes = le({}, w, e.attributes), e.styles = le({}, p, e.styles), e.arrowStyles = le({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
            ...
            applyStyle: {
                ...
                enabled: !0,
                fn: function (e) {
                    return W(e.instance.popper, e.styles), R(e.instance.popper, e.attributes), e.arrowElement && Object.keys(e.arrowStyles).length && W(e.arrowElement, e.arrowStyles), e
                },
...
! function (e) {
    ...
    function () {
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            s = (function (e) {
                ...
                e(document).on(a.CLICK_DATA_API, s.DISMISS, c._handleDismiss(new c)), e.fn[t] = c._jQueryInterface, e.fn[t].Constructor = c, e.fn[t].noConflict = function () {
                ...
                var t = "button",
                    ...
                    l = function () {
                        ...
                        return t.prototype.toggle = function () {
                            var t = !0,
                                n = !0,
                                i = e(this._element).closest(s.DATA_TOGGLE)[0];
                            if (i) {
                ...
                e(document).on(a.CLICK_DATA_API, s.DATA_TOGGLE_CARROT, function (t) {
                    t.preventDefault();
                    var n = t.target;
                    e(n).hasClass(r.BUTTON) || (n = e(n).closest(s.BUTTON)), l._jQueryInterface.call(e(n), "toggle")
                ...
                var t = "carousel",
                    ...
                    m = function () {
                        ...
                        return l.prototype.next = function () {
                            ...
                            t || (this._isPaused = !0), e(this._element).find(f.NEXT_PREV)[0] && r.supportsTransitionEnd() && (r.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                            ...
                            var s = (o + (e === d.PREV ? -1 : 1)) % this._items.length;
                            ...
                            var i = this,
                                ...
                                m = void 0,
                                g = void 0;
                            if (t === d.NEXT ? (u = h.LEFT, m = h.NEXT, g = d.LEFT) : (u = h.RIGHT, m = h.PREV, g = d.RIGHT), a && e(a).hasClass(h.ACTIVE)) this._isSliding = !1;
                                ...
                                r.supportsTransitionEnd() && e(this._element).hasClass(h.SLIDE) ? (e(a).addClass(m), r.reflow(a), e(o).addClass(u), e(a).addClass(u), e(o).one(r.TRANSITION_END, function () {
                                    e(a).removeClass(u + " " + m).addClass(h.ACTIVE), e(o).removeClass(h.ACTIVE + " " + m + " " + u), i._isSliding = !1, setTimeout(function () {
                                        return e(i._element).trigger(v)
                                    }, 0)
                                }).emulateTransitionEnd(600)) : (e(o).removeClass(h.ACTIVE), e(a).addClass(h.ACTIVE), this._isSliding = !1, e(this._element).trigger(v)), c && this.cycle()
                            }
                ...
                e(document).on(p.CLICK_DATA_API, f.DATA_SLIDE, m._dataApiClickHandler), e(window).on(p.LOAD_DATA_API, function () {
                ...
                var t = "collapse",
                    ...
                    f = function () {
                        function a(t, i) {
                            ...
                            for (var o = e(h.DATA_TOGGLE), s = 0; s < o.length; s++) {
                                var l = o[s],
                        ...
                        return a.prototype.toggle = function () {
                            ...
                            if (!this._isTransitioning && !e(this._element).hasClass(d.SHOW)) {
                                var n = void 0,
                                    i = void 0;
                                if (this._parent && ((n = e.makeArray(e(this._parent).children().children(h.ACTIVES))).length || (n = null)), !(n && (i = e(n).data(s)) && i._isTransitioning)) {
                                    ...
                                    if (e(this._element).trigger(o), !o.isDefaultPrevented()) {
                                        ...
                                        if (r.supportsTransitionEnd()) {
                                            ...
                                            e(this._element).one(r.TRANSITION_END, c).emulateTransitionEnd(600), this._element.style[l] = this._element[p] + "px"
                                        } else c()
                                    }
                                }
                            }
                                ...
                                if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                                    ...
                                    if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", r.reflow(this._element), e(this._element).addClass(d.COLLAPSING).removeClass(d.COLLAPSE).removeClass(d.SHOW), this._triggerArray.length)
                                        for (var o = 0; o < this._triggerArray.length; o++) {
                                            ...
                                            null !== a && (e(a).hasClass(d.SHOW) || e(s).addClass(d.COLLAPSED).attr("aria-expanded", !1))
                                        }
                ...
                var t = "dropdown",
                    ...
                    g = function () {
                        ...
                        return l.prototype.toggle = function () {
                            if (!this._element.disabled && !e(this._element).hasClass(d.DISABLED)) {
                                ...
                                if (l._clearMenus(), !n) {
                                    ...
                                    if (e(t).trigger(o), !o.isDefaultPrevented()) {
                                        var r = this._element;
                                        e(t).hasClass(d.DROPUP) && (e(this._menu).hasClass(d.MENULEFT) || e(this._menu).hasClass(d.MENURIGHT)) && (r = t), this._popper = new Popper(r, this._menu, this._getPopperConfig()), "ontouchstart" in document.documentElement && !e(t).closest(p.NAVBAR_NAV).length && e("body").children().on("mouseover", null, e.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), e(this._menu).toggleClass(d.SHOW), e(t).toggleClass(d.SHOW).trigger(e.Event(u.SHOWN, i))
                                    }
                                }
                            }
                        }, l.prototype.dispose = function () {
                            ...
                            return void 0 !== i.placement && (i.placement = h[i.placement.toUpperCase()]), n = e.extend({}, this.constructor.Default, e(this._element).data(), n), r.typeCheckConfig(t, n, this.constructor.DefaultType), n
                                ...
                                for (var n = e.makeArray(e(p.DATA_TOGGLE)), i = 0; i < n.length; i++) {
                                    ...
                                    if (r) {
                                        ...
                                        if (e(o).hasClass(d.SHOW) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && e.contains(o, t.target))) {
                                            var h = e.Event(u.HIDE, a);
                                            e(o).trigger(h), h.isDefaultPrevented() || ("ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), n[i].setAttribute("aria-expanded", "false"), e(c).removeClass(d.SHOW), e(o).removeClass(d.SHOW).trigger(e.Event(u.HIDDEN, a)))
                                        }
                                    }
                                }
                ...
                e(document).on(u.KEYDOWN_DATA_API, p.DATA_TOGGLE, g._dataApiKeydownHandler).on(u.KEYDOWN_DATA_API, p.MENU, g._dataApiKeydownHandler).on(u.CLICK_DATA_API + " " + u.KEYUP_DATA_API, g._clearMenus).on(u.CLICK_DATA_API, p.DATA_TOGGLE, function (t) {
                    ...
                    h = function () {
                        ...
                        return a.prototype.toggle = function (e) {
                            ...
                            if (!this._isTransitioning) {
                                ...
                                e(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), e(document.body).addClass(d.OPEN), this._setEscapeEvent(), this._setResizeEvent(), e(this._element).on(u.CLICK_DISMISS, p.DATA_DISMISS, function (e) {
                                    return n.hide(e)
                            ...
                            e.removeData(this._element, "bs.modal"), e(window, document, this._element, this._backdrop).off(s), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
                            ...
                            if (this._isShown && this._config.backdrop) {
                                ...
                                r.supportsTransitionEnd() && e(this._element).hasClass(d.FADE) ? e(this._backdrop).one(r.TRANSITION_END, s).emulateTransitionEnd(150) : s()
                            } else t && t()
                            ...
                            return this.each(function () {
                                var o = e(this).data("bs.modal"),
                                    r = e.extend({}, a.Default, e(this).data(), "object" === (void 0 === t ? "undefined" : i(t)) && t);
                                if (o || (o = new a(this, r), e(this).data("bs.modal", o)), "string" == typeof t) {
                                    if (void 0 === o[t]) throw new Error('No method named "' + t + '"');
                                    o[t](n)
                ...
                var t = "scrollspy",
                    ...
                    h = function () {
                        function s(t, i) {
                            var o = this;
                            n(this, s), this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(i), this._selector = this._config.target + " " + d.NAV_LINKS + "," + this._config.target + " " + d.LIST_ITEMS + "," + this._config.target + " " + d.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement).on(c.SCROLL, function (e) {
                                return o._process(e)
                        ...
                        return s.prototype.refresh = function () {
                            ...
                            return this.each(function () {
                                ...
                                if (n || (n = new s(this, o), e(this).data("bs.scrollspy", n)), "string" == typeof t) {
                                    if (void 0 === n[t]) throw new Error('No method named "' + t + '"');
                                    n[t]()
                                }
                            })
                    ...
                    l = function () {
                        ...
                        return t.prototype.show = function () {
                            ...
                            var o = this,
                                ...
                                c = i && r.supportsTransitionEnd() && l && e(l).hasClass(s.FADE),
                                u = function () {
                                    return o._transitionComplete(t, l, c, i)
                                };
                            l && c ? e(l).one(r.TRANSITION_END, u).emulateTransitionEnd(150) : u(), l && e(l).removeClass(s.SHOW)
                            ...
                            if (n) {
                                ...
                                l && e(l).removeClass(s.ACTIVE), n.setAttribute("aria-expanded", !1)
                            }
                            if (e(t).addClass(s.ACTIVE), t.setAttribute("aria-expanded", !0), i ? (r.reflow(t), e(t).addClass(s.SHOW)) : e(t).removeClass(s.FADE), t.parentNode && e(t.parentNode).hasClass(s.DROPDOWN_MENU)) {
                                var c = e(t).closest(a.DROPDOWN)[0];
                                c && e(c).find(a.DROPDOWN_TOGGLE).addClass(s.ACTIVE), t.setAttribute("aria-expanded", !0)
                            }
                            o && o()
                        }, t._jQueryInterface = function (n) {
                            return this.each(function () {
                    ...
                    v = function () {
                        ...
                        return a.prototype.enable = function () {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                r.supportsTransitionEnd() && e(this.tip).hasClass(f.FADE) ? e(this.tip).one(r.TRANSITION_END, d).emulateTransitionEnd(a._TRANSITION_DURATION) : d()
                            }
                        }, a.prototype.hide = function (t) {
                            var n = this,
        ...
        ! function (r) {
            var a = "popover",
                ...
                g = function (s) {
                    function c() {
                        return n(this, c), e(this, s.apply(this, arguments))
                    }
                    return t(c, s), c.prototype.isWithContent = function () {
        ...
        function r(t) {
            if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var m = a.paddingLeft + a.paddingRight,
                    ...
                    T = u && s,
                    _ = e(r.width);
                !1 !== _ && (a.width = _ + (T ? 0 : m + b));
                var E = e(r.height);
                return !1 !== E && (a.height = E + (T ? 0 : g + w)), a.innerWidth = a.width - (m + b), a.innerHeight = a.height - (g + w), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
            }
        }
    ...
    function (e, t) {
        ...
        return i._resetLayout = function () {
            ...
            for (var o = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", r = this[o](i, e), s = {
                ...
                y: r.y
            }, a = r.y + e.size.outerHeight, l = i + r.col, c = r.col; l > c; c++) this.colYs[c] = a;
            return s
    ...
    function (e, t) {
        ...
        function t(e) {
            if (e in Y) return e;
            for (var t = e[0].toUpperCase() + e.slice(1), n = V.length; n--;)
                if ((e = V[n] + t) in Y) return e
        }
        ...
        function u(e, t, n) {
            ...
            return i.style.opacity = 0, new Promise(function (t) {
                ...
                if (i.src === e) return void o();
                i.exifdata = null, i.removeAttribute("crossOrigin"), e.match(/^https?:\/\/|^\/\//) && i.setAttribute("crossOrigin", "anonymous"), i.onload = function () {
        ...
        function f() {
            var e, t, n, i, o, a = this,
                c = a.options.viewport.type ? "cr-vp-" + a.options.viewport.type : null;
            a.options.useCanvas = a.options.enableOrientation || m.call(a), a.data = {}, a.elements = {}, e = a.elements.boundary = document.createElement("div"), t = a.elements.viewport = document.createElement("div"), a.elements.img = document.createElement("img"), n = a.elements.overlay = document.createElement("div"), a.options.useCanvas ? (a.elements.canvas = document.createElement("canvas"), a.elements.preview = a.elements.canvas) : a.elements.preview = a.elements.img, s(e, "cr-boundary"), e.setAttribute("aria-dropeffect", "none"), i = a.options.boundary.width, o = a.options.boundary.height, r(e, {
                width: i + (isNaN(i) ? "" : "px"),
                height: o + (isNaN(o) ? "" : "px")
            }), s(t, "cr-viewport"), c && s(t, c), r(t, {
                width: a.options.viewport.width + "px",
                height: a.options.viewport.height + "px"
            }), t.setAttribute("tabindex", 0), s(a.elements.preview, "cr-image"), l(a.elements.preview, {
                alt: "",
                "aria-grabbed": "false"
            }), s(n, "cr-overlay"), a.element.appendChild(e), e.appendChild(a.elements.preview), e.appendChild(t), e.appendChild(n), s(a.element, "croppie-container"), a.options.customClass && s(a.element, a.options.customClass), _.call(this), a.options.enableZoom && y.call(a), a.options.enableResize && g.call(a)
        }
        ...
        function g() {
            function e(e) {
                if ((void 0 === e.button || 0 === e.button) && (e.preventDefault(), !f)) {
                    var r = p.elements.overlay.getBoundingClientRect();
                    if (f = !0, o = e.pageX, a = e.pageY, i = -1 !== e.currentTarget.className.indexOf("vertical") ? "v" : "h", l = r.width, c = r.height, e.touches) {
                        var s = e.touches[0];
                        o = s.pageX, a = s.pageY
                    }
                    window.addEventListener("mousemove", t), window.addEventListener("touchmove", t), window.addEventListener("mouseup", n), window.addEventListener("touchend", n), document.body.style[U] = "none"
                }
            }
            ...
            function t(e) {
                ...
                var u = t - o,
                    d = n - a,
                    f = p.options.viewport.height + d,
                    g = p.options.viewport.width + u;
                "v" === i && f >= m && f <= c ? (r(h, {
                    height: f + "px"
                }), p.options.boundary.height += d, r(p.elements.boundary, {
                    height: p.options.boundary.height + "px"
                }), p.options.viewport.height += d, r(p.elements.viewport, {
                    height: p.options.viewport.height + "px"
                })) : "h" === i && g >= m && g <= l && (r(h, {
                    width: g + "px"
                }), p.options.boundary.width += u, r(p.elements.boundary, {
                    width: p.options.boundary.width + "px"
                }), p.options.viewport.width += u, r(p.elements.viewport, {
                    width: p.options.viewport.width + "px"
                })), E.call(p), k.call(p), T.call(p), C.call(p), a = n, o = t
            }

            function n() {
                f = !1, window.removeEventListener("mousemove", t), window.removeEventListener("touchmove", t), window.removeEventListener("mouseup", n), window.removeEventListener("touchend", n), document.body.style[U] = ""
            }
            var i, o, a, l, c, u, d, p = this,
        ...
        function y() {
            function e() {
                b.call(n, {
                    ...
                    origin: new Q(n.elements.preview),
                    viewportRect: n.elements.viewport.getBoundingClientRect(),
                    transform: X.parse(n.elements.preview)
                })
            }

            function t(t) {
                var i, o;
                i = t.wheelDelta ? t.wheelDelta / 1200 : t.deltaY ? t.deltaY / 1060 : t.detail ? t.detail / -60 : 0, o = n._currentZoom + i * n._currentZoom, t.preventDefault(), v.call(n, o), e.call(n)
            }
            var n = this,
                i = n.elements.zoomerWrap = document.createElement("div"),
                o = n.elements.zoomer = document.createElement("input");
            s(i, "cr-slider-wrap"), s(o, "cr-slider"), o.type = "range", o.step = "0.0001", o.value = 1, o.style.display = n.options.showZoomer ? "" : "none", o.setAttribute("aria-label", "zoom"), n.element.appendChild(i), i.appendChild(o), n._currentZoom = 1, n.elements.zoomer.addEventListener("input", e), n.elements.zoomer.addEventListener("change", e), n.options.mouseWheelZoom && (n.elements.boundary.addEventListener("mousewheel", t), n.elements.boundary.addEventListener("DOMMouseScroll", t))
        }

        function b(e) {
            function t() {
                var e = {};
                e[q] = i.toString(), e[B] = s.toString(), r(n.elements.preview, e)
            }
            var n = this,
                i = e ? e.transform : X.parse(n.elements.preview),
                o = e ? e.viewportRect : n.elements.viewport.getBoundingClientRect(),
                s = e ? e.origin : new Q(n.elements.preview);
            if (n._currentZoom = e ? e.value : n._currentZoom, i.scale = n._currentZoom, n.elements.zoomer.setAttribute("aria-valuenow", n._currentZoom), t(), n.options.enforceBoundary) {
                var a = w.call(n, o),
                    l = a.translate,
                    c = a.origin;
                i.x >= l.maxX && (s.x = c.minX, i.x = l.maxX), i.x <= l.minX && (s.x = c.maxX, i.x = l.minX), i.y >= l.maxY && (s.y = c.minY, i.y = l.maxY), i.y <= l.minY && (s.y = c.maxY, i.y = l.minY)
            }
            t(), K.call(n), C.call(n)
        }
        ...
        function w(e) {
            var t = this,
                ...
                s = t.elements.boundary.clientHeight / 2,
        ...
        function T() {
            var e = this,
                ...
                o = X.parse(e.elements.preview.style[q]),
                s = new Q(e.elements.preview),
                a = i.top - n.top + i.height / 2,
                l = i.left - n.left + i.width / 2,
                c = {},
                u = {};
            c.y = a / t, c.x = l / t, u.y = (c.y - s.y) * (1 - t), u.x = (c.x - s.x) * (1 - t), o.x -= u.x, o.y -= u.y;
            var d = {};
            d[B] = c.x + "px " + c.y + "px", d[q] = o.toString(), r(e.elements.preview, d)
        }
        ...
        function _() {
            function e(e, t) {
                var n = f.elements.preview.getBoundingClientRect(),
                    i = h.y + t,
                    o = h.x + e;
                f.options.enforceBoundary ? (p.top > n.top + t && p.bottom < n.bottom + t && (h.y = i), p.left > n.left + e && p.right < n.right + e && (h.x = o)) : (h.y = i, h.x = o)
            }
            ...
            function n(e) {
                ...
                var n = 37,
                    ...
                    r = 39,
                    s = 40;
                if (!e.shiftKey || e.keyCode != o && e.keyCode != s) {
                    if (f.options.enableKeyMovement && e.keyCode >= 37 && e.keyCode <= 40) {
                        e.preventDefault();
                        var a = t(e.keyCode);
                        h = X.parse(f.elements.preview), document.body.style[U] = "none", p = f.elements.viewport.getBoundingClientRect(), i(a)
                    }
                } else {
                    var l = 0;
                    l = e.keyCode == o ? parseFloat(f.elements.zoomer.value, 10) + parseFloat(f.elements.zoomer.step, 10) : parseFloat(f.elements.zoomer.value, 10) - parseFloat(f.elements.zoomer.step, 10), f.setZoom(l)
                }
            }
            ...
            function i(t) {
                var n = t[0],
                    i = t[1],
                    o = {};
                e(n, i), o[q] = h.toString(), r(f.elements.preview, o), E.call(f), document.body.style[U] = "", T.call(f), C.call(f), d = 0
            }

            function s(e) {
                if ((void 0 === e.button || 0 === e.button) && (e.preventDefault(), !m)) {
                    if (m = !0, c = e.pageX, u = e.pageY, e.touches) {
                        var n = e.touches[0];
                        c = n.pageX, u = n.pageY
                    }
                    t(m), h = X.parse(f.elements.preview), window.addEventListener("mousemove", a), window.addEventListener("touchmove", a), window.addEventListener("mouseup", l), window.addEventListener("touchend", l), document.body.style[U] = "none", p = f.elements.viewport.getBoundingClientRect()
                }
            }
            ...
            function a(t) {
                ...
                if ("touchmove" == t.type && t.touches.length > 1) {
                    var m = t.touches[0],
                        g = t.touches[1],
                        y = Math.sqrt((m.pageX - g.pageX) * (m.pageX - g.pageX) + (m.pageY - g.pageY) * (m.pageY - g.pageY));
                    d || (d = y / f._currentZoom);
                    var b = y / d;
                    return v.call(f, b), void o(f.elements.zoomer)
                }
                e(a, l), p[q] = h.toString(), r(f.elements.preview, p), E.call(f), u = i, c = n
            }

            function l() {
                m = !1, t(m), window.removeEventListener("mousemove", a), window.removeEventListener("touchmove", a), window.removeEventListener("mouseup", l), window.removeEventListener("touchend", l), document.body.style[U] = "", T.call(f), C.call(f), d = 0
            }
            var c, u, d, p, h, f = this,
                m = !1;
            f.elements.overlay.addEventListener("mousedown", s), f.elements.viewport.addEventListener("keydown", n), f.elements.overlay.addEventListener("touchstart", s)
        }
        ...
        function x() {
            var e = this,
                ...
                s = new X(0, 0, t),
                a = new Q;
            S.call(e) && !e.data.bound && (e.data.bound = !0, n[q] = s.toString(), n[B] = a.toString(), n.opacity = 1, r(i, n), e._originalImageWidth = o.width, e._originalImageHeight = o.height, e.options.enableZoom ? k.call(e, !0) : e._currentZoom = t, s.scale = e._currentZoom, n[q] = s.toString(), r(i, n), e.data.points.length ? A.call(e, e.data.points) : O.call(e), T.call(e), E.call(e))
        }
        ...
        function k(e) {
            var t, n, i, r, s = this,
                ...
                l = 1.5,
                c = s.elements.zoomer,
                u = parseFloat(c.value),
                d = s.elements.boundary.getBoundingClientRect(),
                p = s.elements.preview.getBoundingClientRect(),
                h = s.elements.viewport.getBoundingClientRect();
            s.options.enforceBoundary && (i = h.width / (e ? p.width : p.width / u), r = h.height / (e ? p.height : p.height / u), a = Math.max(i, r)), a >= l && (l = a + 1), c.min = $(a, 4), c.max = $(l, 4), e && (n = Math.max(d.width / p.width, d.height / p.height), t = null !== s.data.boundZoom ? s.data.boundZoom : n, v.call(s, t)), o(c)
        }
        ...
        function A(e) {
            ...
            var t = this,
                ...
                d = -1 * e[0] + s.left,
                p = {};
            p[B] = c + "px " + l + "px", p[q] = new X(d, u, a).toString(), r(t.elements.preview, p), v.call(t, a), t._currentZoom = a
        }
        ...
        function O() {
            var e = this,
                ...
                l = s - (t.height - n.height) / 2,
                c = new X(a, l, e._currentZoom);
            r(e.elements.preview, q, c.toString())
        }
        ...
        function I(e) {
            ...
            o.clearRect(0, 0, n.width, n.height), n.width = i.width, n.height = i.height, r && !e ? h(n, i, c(p(i) || 0, 10)) : e && h(n, i, e)
        }
        ...
        function D(e) {
            var t = this,
                ...
                v = h,
                y = f,
                b = e.outputWidth && e.outputHeight,
                w = 1;
            return b && (v = e.outputWidth, y = e.outputHeight, w = v / h), d.width = v, d.height = y, e.backgroundColor && (p.fillStyle = e.backgroundColor, p.fillRect(0, 0, h, f)), t.options.enforceBoundary || (i < 0 && (m = Math.abs(i), i = 0), o < 0 && (g = Math.abs(o), o = 0), r > t._originalImageWidth && (a = t._originalImageWidth - i, h = a), s > t._originalImageHeight && (l = t._originalImageHeight - o, f = l)), 1 !== w && (m *= w, g *= w, h *= w, f *= w), p.drawImage(this.elements.preview, i, o, Math.min(a, t._originalImageWidth), Math.min(l, t._originalImageHeight), m, g, h, f), u && (p.fillStyle = "#fff", p.globalCompositeOperation = "destination-in", p.beginPath(), p.arc(h / 2, f / 2, h / 2, 0, 2 * Math.PI, !0), p.closePath(), p.fill()), d
        }
        ...
        function N(e) {
            var t = e.points,
                ...
                o = t[2] - t[0],
                a = t[3] - t[1];
            return s(n, "croppie-result"), n.appendChild(i), r(i, {
                left: -1 * t[0] + "px",
                top: -1 * t[1] + "px"
            }), i.src = e.url, r(n, {
                width: o + "px",
        ...
        function H(e, t) {
            ...
            if ("string" == typeof e) n = e, e = {};
                ...
                if (void 0 === e && i.data.url) return x.call(i), C.call(i), null;
                n = e.url, o = e.points || [], r = void 0 === e.zoom ? null : e.zoom
            }
            return i.data.bound = !1, i.data.url = n || i.data.url, i.data.boundZoom = r, u(n, i.elements.img, s).then(function (n) {
                if (o.length) i.options.relative && (o = [o[0] * n.naturalWidth / 100, o[1] * n.naturalHeight / 100, o[2] * n.naturalWidth / 100, o[3] * n.naturalHeight / 100]);
                else {
                    var r, s, a = d(n),
                        l = i.elements.viewport.getBoundingClientRect(),
                        c = l.width / l.height;
                    a.width / a.height > c ? (s = a.height, r = s * c) : (r = a.width, s = r / c);
                    var u = (a.width - r) / 2,
                        p = (a.height - s) / 2,
                        h = u + r,
                        f = p + s;
                    i.data.points = [u, p, h, f]
                }
                i.data.points = o.map(function (e) {
                    return parseFloat(e)
                }), i.options.useCanvas && I.call(i, e.orientation || 1), x.call(i), C.call(i), t && t()
            })
        }
        ...
        function j() {
            var e = this,
                ...
                s = (n.height - e.elements.viewport.offsetHeight) / 2,
                a = i + e.elements.viewport.offsetWidth + r,
                l = o + e.elements.viewport.offsetHeight + s,
                c = e._currentZoom;
            (c === 1 / 0 || isNaN(c)) && (c = 1);
            var u = e.options.enforceBoundary ? 0 : Number.NEGATIVE_INFINITY;
            return i = Math.max(u, i / c), o = Math.max(u, o / c), a = Math.max(u, a / c), l = Math.max(u, l / c), {
                points: [$(i), $(o), $(a), $(l)],
                zoom: c
            }
        }
        ...
        function W(e) {
            var t = this,
                ...
                l = o.quality,
                c = o.backgroundColor,
                u = "boolean" == typeof o.circle ? o.circle : "circle" === t.options.viewport.type,
                d = t.elements.viewport.getBoundingClientRect(),
                p = d.width / d.height;
            return "viewport" === s ? (i.outputWidth = d.width, i.outputHeight = d.height) : "object" == typeof s && (s.width && s.height ? (i.outputWidth = s.width, i.outputHeight = s.height) : s.width ? (i.outputWidth = s.width, i.outputHeight = s.width / p) : s.height && (i.outputWidth = s.height * p, i.outputHeight = s.height)), J.indexOf(a) > -1 && (i.format = "image/" + a, i.quality = l), i.circle = u, i.url = t.data.url, i.backgroundColor = c, new Promise(function (e, n) {
        ...
        function M(e) {
            ...
            var t = this,
                ...
                o = 1;
            i.width = n.width, i.height = n.height, i.getContext("2d").drawImage(n, 0, 0), 90 !== e && -270 !== e || (o = 6), -90 !== e && 270 !== e || (o = 8), 180 !== e && -180 !== e || (o = 3), h(n, i, o), b.call(t), i = null
        }
        ...
        function z(e, t) {
            if (this.element = e, this.options = n(n({}, z.defaults), t), "img" === this.element.tagName.toLowerCase()) {
                var i = this.element;
                s(i, "cr-original-image"), l(i, {
                    "aria-hidden": "true",
                    alt: ""
                });
            ...
            if (f.call(this), this.options.url) {
                var r = {
                    url: this.options.url,
                    points: this.options.points
                };
                delete this.options.url, delete this.options.points, H.call(this, r)
            }
        }
        "function" != typeof Promise && function (e) {
            ...
            value: function (e, t, n) {
                for (var i = atob(this.toDataURL(t, n).split(",")[1]), o = i.length, r = new Uint8Array(o), s = 0; s < o; s++) r[s] = i.charCodeAt(s);
                e(new Blob([r], {
                    type: t || "image/png"
                }))
            }
        });
        var B, q, U, V = ["Webkit", "Moz", "ms"],
            Y = document.createElement("div").style;
        q = t("transform"), B = t("transformOrigin"), U = t("userSelect");
        var G = {
            translate3d: {
                suffix: ", 0px"
            },
        ...
        X.parse = function (e) {
            return e.style ? X.parse(e.style[q]) : e.indexOf("matrix") > -1 || e.indexOf("none") > -1 ? X.fromMatrix(e) : X.fromString(e)
        }, X.fromMatrix = function (e) {
            var t = e.substring(7).split(",");
            return t.length && "none" !== e || (t = [1, 0, 0, 1, 0, 0]), new X(c(t[4]), c(t[5]), parseFloat(t[0]))
        }, X.fromString = function (e) {
            var t = e.split(") "),
                n = t[0].substring(z.globals.translate.length + 1).split(","),
                i = t.length > 1 ? t[1].substring(6) : 1,
                o = n.length > 1 ? n[0] : 0,
                r = n.length > 1 ? n[1] : 0;
            return new X(o, r, i)
        }, X.prototype.toString = function () {
            var e = G[z.globals.translate].suffix || "";
            return z.globals.translate + "(" + this.x + "px, " + this.y + "px" + e + ") scale(" + this.scale + ")"
        };
        var Q = function (e) {
            if (!e || !e.style[B]) return this.x = 0, void (this.y = 0);
            var t = e.style[B].split(" ");
        ...
        }), e.Croppie = window.Croppie = z, "object" == typeof module && module.exports && (module.exports = z)
    }), $(document).ready(function () {
        function e() {
            var e = $(window).width();
            number = e > 991 ? 3 : e > 375 ? 2 : 1
        }
        var t = new Date,
            n = new Array(7);
        n[0] = "Неділя", n[1] = "Понеділок", n[2] = "Вівторок", n[3] = "Середа", n[4] = "Четвер", n[5] = "П'ятниця", n[6] = "Субота";
        var i = n[t.getDay()],
            o = t.toLocaleDateString();
        if ($("#my-datepicker").val(i + " " + o), e(), $(window).on("resize", e), $(".slick-carousel").on("init", function () {
            $(".slick-carousel").css({
                visibility: "visible"
            })
        }), $("div").is(".carousel-popular-theme")) {
            var r = $(".paging-popular-theme"),
                s = $(".carousel-popular-theme");
            s.on("init reInit afterChange", function (e, t, n, i) {
                var o = (n || 0) + number;
                o > t.slideCount ? r.text(t.slideCount + "/" + t.slideCount) : r.text(o + "/" + t.slideCount)
            }), s.slick({
                infinite: !1,
                speed: 300,
                slidesToShow: 3,
        ...
        if ($("div").is(".carousel-editorial-choice")) {
            var a = $(".paging-editorial-choice"),
                l = $(".carousel-editorial-choice");
            l.on("init reInit afterChange", function (e, t, n, i) {
                var o = (n || 0) + number;
                o > t.slideCount ? a.text(t.slideCount + "/" + t.slideCount) : a.text(o + "/" + t.slideCount)
            }), l.slick({
                infinite: !1,
                speed: 300,
                slidesToShow: 3,
        ...
        if ($("div").is(".carousel-top-blog")) {
            var c = $(".carousel-top-blog"),
                u = $(".paging-blog");
            c.on("init reInit afterChange", function (e, t, n, i) {
                var o = (n || 0) + number;
                o > t.slideCount ? u.text(t.slideCount + "/" + t.slideCount) : u.text(o + "/" + t.slideCount)
            }), c.slick({
                infinite: !1,
                speed: 300,
                slidesToShow: 3,
        ...
        var e = $(this),
            t = e.val();
        $("." + e.attr("id")).html(e.val()), t.length > 1 ? $("." + e.attr("id")).prev("i").removeClass("d-none") : t.length < 1 && $("." + e.attr("id")).prev("i").addClass("d-none"), $("#input-value-name").val().length < 1 && $(".input-value-name").html("Ім’я"), $("#input-value-lastname").val().length < 1 && $(".input-value-lastname").html("Прізвище"), $("#input-value-autobiography").val().length < 1 && $(".input-value-autobiography").html("Ваша біографія")
    }), $(".item-blog-news").each(function () {
        var e = $(this);
        e.find(".title-news").height() < 19 && e.find(".text-news").removeClass("brief-description")
    }), $(".item-all-news").each(function () {
        var e = $(this);
        e.find(".title-news").height() < 19 && e.find(".text-news").removeClass("brief-description")
    }), $(".btn-edit").click(function () {
        var e = $(this).parents(".block-edit").data("edit"),
            t = $(".edit-" + e).find(".form-control"),
            n = $(".edit-" + e).find(".upload-result"),
            i = $(".edit-" + e).find("#upload");
        $(".edit-" + e).find("button.btn-edit").attr("hidden", "hidden"), $(".edit-" + e).find('button[type="submit"]').removeAttr("hidden"), $(t).hasClass("disabled") && (t.removeClass("disabled"), t.removeAttr("disabled readonly"), n.removeAttr("disabled"), i.removeAttr("disabled"))
    }), $(function (e) {
        var t = window.location.href;
        e(".navbar-nav a").each(function () {
            this.href === t && e(this).parent().addClass("active")
        })
    }), $("div").is(".grid") && $(".grid").masonry({
        itemSelector: ".grid-item"
    }), $("textarea").is(".textarea") && tinymce.init({
        selector: ".textarea",
        language: "uk_UA"
    });